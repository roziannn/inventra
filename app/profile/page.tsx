      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="px-2 py-0.5 bg-amber-50 text-amber-600 text-xs font-bold uppercase tracking-wider rounded border border-amber-100">Read-Only</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
              <div className="w-24 h-24 bg-zinc-900 rounded-full flex items-center justify-center text-white text-3xl font-bold mx-auto shadow-lg mb-4">AD</div>
              <h2 className="text-lg font-bold text-gray-900">Admin User</h2>
              <p className="text-sm text-violet-500 font-semibold uppercase tracking-wider mt-1">Manager</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Nama Lengkap</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Nomor Telepon</label>
                  <input 
                    type="text" 
              ...
              <div className="mt-8 pt-4 border-t border-gray-50 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-zinc-900 text-white rounded-xl text-sm font-bold shadow-md hover:bg-zinc-800 transition-colors shrink-0"
                >
